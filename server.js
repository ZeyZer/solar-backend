...
// TARIFF STUFF
const {normalizeTariff, isRetailRateTariff, rateForHour, computeHourlyBilling,} = require("./services/tariffService");
...
// BATTERY SIMULATIONS
const {simulateHourByHour, simulateWithTariff,} = require("./services/batterySimulationService");
